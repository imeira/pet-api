package com.imeira.pet.api.exception;
...
import com.imeira.pet.api.service.exception.ObjectNotEnabledException;
...
public class RestResponseEntityExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleInvalidPet(final
                                                         RuntimeException e, HttpServletRequest request) {
        LOG.error(e.getMessage());
